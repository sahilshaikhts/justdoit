...
const { GetTasks,GetTask, CreateTask,UpdateTask,DeleteTask,SetTaskProgress } = require("../Controllers/tasks-controller");
...
router.route("/delete-task").put(CheckIfUserHaveAccess(UserRoles.Moderator,true),DeleteTask);
