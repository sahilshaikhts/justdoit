                ...
                mappedUser.push(<div className="list_members" key={key}><img src={projectMembers.get(key).image_url} /><span>{member.username}</span>
                    {(key !== currentUser.id && userRole >= 2) &&
                        <><div className="menu_role">
                            ...
                            <button className="btn_kickUser" onClick={() => HandleRemoveMember(member, key)}><img src="/Frontend/Images/icon_kickUser.svg" alt="kick" /></button>
                        </>
                    }
                </div>);
            });
    ...
    return <>
        <div className="details-sidebar">
            ...
            <div className="section_leaveButtons">
                <button className="button-leave" onClick={HandleButtonLeave}><img src="/FrontEnd\Images\icon_exit.svg" /><h2>Leave project</h2></button>
                <button className="button-nuke" onClick={HandleButtonNuke}><img src="/FrontEnd\Images\icon_nuke.svg" /></button>
            </div>
        </div>
        {
            bShowAddMember &&
